...
{
    @objc open class func liberty () -> [UIColor]
    {
        return [
    ...
    @objc open class func joyful () -> [UIColor]
    {
        return [
    ...
    @objc open class func pastel () -> [UIColor]
    {
        return [
    ...
    @objc open class func colorful () -> [UIColor]
    {
        return [
    ...
    @objc open class func vordiplom () -> [UIColor]
    {
        return [
    ...
    @objc open class func material () -> [UIColor]
    {
        return [
